...
static const BBCT_CONFIG _configs[] = {
       // sda, scl, int, rst
       {33, 32, 25, 21}, //CONFIG_CYD_28C - CST820
       {4, 8, 3, -1}, //CONFIG_CYD_35C - AXS15231
       {19, 20, 18, 38}, //CONFIG_CYD_43C - GT911 - INT 18 After mod
       {19, 20, -1, 38}, //CONFIG_CYD_550 - GT911 - INT 18 After mod
       {19, 45, -1, -1}, //CONFIG_CYD_040 - GT911
       {18, 8, -1, -1}, //CONFIG_TDECK - GT911
       {0,0,0,0}
    };
